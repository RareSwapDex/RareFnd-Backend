...
# a = get_user_model().objects.create(username= 'jaliloppl', password='jalilrooney', 
#                                        email='benharkatdjalil@gmail.com',first_name= 'Abdeldjalil',
#                                        last_name= 'BENHARKAT', phone= '+213699752382', 
