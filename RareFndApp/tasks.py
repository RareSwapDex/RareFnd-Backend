    ...
    for p in pending_contributions:
        ...
        if (
            ...
            if (
                ...
                tx_project_company_rewarded_amount = getattr(
                    tx_project, "rewarded_amount"
                )
                if (
                    tx_project_raised_amount
                    + tx_project_current_reward
                    + tx_project_company_rewarded_amount
